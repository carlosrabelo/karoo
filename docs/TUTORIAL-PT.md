...
- `backups`: lista de pools de backup para failover (opcional).
- `proxy.tls`: caminhos do certificado SSL para conexões seguras downstream (opcional).
...
- Problemas de build: certifique-se de ter Go 1.18+ instalado e execute `make mod-tidy` para limpar dependências.
