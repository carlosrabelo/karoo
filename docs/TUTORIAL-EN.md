...
- `backups`: list of backup pools for failover (optional).
- `proxy.tls`: SSL certificate paths for secure downstream connections (optional).
...
- Build issues: ensure Go 1.18+ is installed and run `make mod-tidy` to clean dependencies.
